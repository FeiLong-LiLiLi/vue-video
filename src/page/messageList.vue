    ...
    <div class="fillcontain">
        ...
        <div class="table-container">
            <div class="table-header">
                ...
                <el-button type="primary" @click="addUserInfo">发布通知</el-button>
                </div>
            </div>
           ...
           <!-- 分页开始 -->
            ...
            <!-- 弹窗修改视频信息开始 -->
            <el-dialog title="修改通知信息" :visible.sync="dialogFormVisible" :show-close="false" >
                <div class="updateUserInfo">
                    <!-- <template slot-scope="props"> -->
                        <el-form :model="updataUserInfo">
                            <el-form-item label="发布人" label-width="100px" prop="user_name">
                                 <span>{{admin}}</span>
                            </el-form-item>
                            <el-form-item label="当前时间" label-width="100px" prop="user_name">
                                 <span>{{now_time}}</span>
                            </el-form-item>
                            <el-form-item label="通知类别" label-width="100px">
            ...
            <el-dialog title="发布通知" :visible.sync="dialogFormVisible_adduser" :show-close="false">
